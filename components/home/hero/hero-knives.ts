 ...
 * show, how it sits on the stage, and the accent/environment language for it.
 */
export type HeroEnvironmentVariant =
  | "tidepool"
  | "forge"
  | "ridge"
  | "workshop"
...
export interface HeroKnifePresentation {
  ...
  environmentVariant: HeroEnvironmentVariant;
